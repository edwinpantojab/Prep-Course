...
function colors(color) {
  ...
  //if(idioma === red) return "This is red";
  //if(idioma === green) return "This is green";
  //if(idioma === orange) return "This is orange"
  //return "color not found"; 
  // otra opcion de if
